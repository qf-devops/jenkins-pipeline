/**
 *
 * Generate reclass OpenStack MK cluster model with OpenContrail with cookiecutter
 *
 * Expected parameters:
 ...
 *   RECLASS_CLUSTER_REPO_URL           URL to git repo to store the generated cluster
 *   RECLASS_CLUSTER_REPO_CREDENTIALS   Credentials to the reclass metadata repository
 *   RECLASS_CLUSTER_REPO_BRANCH        Reclass repository branch
 */
